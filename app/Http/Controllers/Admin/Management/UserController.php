...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.management.user.index')->with('notif_success', 'New user has been saved successfully!');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $user = Admin::withoutGlobalScope('active')->findOrFail($id);
        $roles = Role::orderBy('display_name', 'asc')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.management.user.index')->with('notif_success', 'User has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.management.user.index')->with('notif_success', 'User has been deleted successfully!');
    }
    ...
    public function getData(Request $request)
    {
        ...
        $users = Admin::withoutGlobalScope('active')
        ...
        return Datatables::of($users)
                    ...
                    ->addColumn('action', function($user) {
                        $edit = '<a href="' . route('admin.management.user.edit', $user->id) . '" class="btn btn-sm btn-icon text-default tl-tip" data-toggle="tooltip" data-original-title="Edit user"><i class="icon wb-edit" aria-hidden="true"></i></a>';
                        $changePassword = '<a href="' . route('admin.management.user.other.change-password', $user->id) . '" class="btn btn-sm btn-icon text-default tl-tip"
                                data-toggle="tooltip" data-original-title="Change Password"><i class="icon fa-key" aria-hidden="true"></i></a>';
                        $delete = '<a class="btn btn-sm btn-icon text-danger tl-tip" data-href="' . route('admin.management.user.destroy', $user->id) . '" data-toggle="modal" data-target="#confirm-delete-modal" data-original-title="Delete user"><i class="icon wb-trash" aria-hidden="true"></i></a>';
    ...
    public function updateOtherPassword($id, Request $request)
    {
        ...
        $user = Admin::withoutGlobalScopes(['active'])->findOrFail($id);
        $user->password = bcrypt($request->new_password);
        $user->save();
