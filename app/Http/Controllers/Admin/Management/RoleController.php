...
class RoleController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect()->route('admin.management.role.index')->with('notif_success', 'New role has been added successfully!');
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->route('admin.management.role.index')->with('notif_success', 'The role has been updated successfully!');
    }
    ...
    public function getData()
    {
        ...
        return Datatables::of($roles)
                    ->addColumn('action', function($role) {
                        $edit = '<a href="' . route('admin.management.role.edit', $role->id) . '" class="btn btn-sm btn-icon text-default tl-tip" data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>';
                        $delete = '<a class="btn btn-sm btn-icon text-danger tl-tip" data-href="' . route('admin.management.role.destroy', $role->id) . '" data-toggle="modal" data-target="#confirm-delete-modal" data-original-title="Delete"><i class="icon wb-trash" aria-hidden="true"></i></a>';
