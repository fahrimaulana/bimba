    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function getStudent() {
                ...
                $('#department-price').append('<option value="'+ departmentid +'" selected="selected">'+departmentPrice+'</option>');
            ...
            function getSubTotalTuition() {
                var departmentPrice = parseInt($('.registration').find(":selected").data('department-price'));
                if (!departmentPrice) {
                    departmentPrice = 0;
                }
                ...
                var total = (price * month) + departmentPrice + event + other - voucher;
            ...
            function getGrandTotal() {
                ...
                var grandTotal = grandTotalProduct + grandTotalTuition;
