...
@section('head')
    <title>Media Source List | {{ env('APP_NAME') }}</title>
...
@push('breadcrumb')
    <li class="breadcrumb-item active">Media Source</li>
@endpush
...
@section('content')
    <div class="panel">
        <div class="panel-body">
            ...
            @can('create-media-source')
            <div class="row">
                <div class="col-xs-12">
                    <div class="m-b-15">
                        <a id="add-btn" class="btn btn-primary white">
                            <i class="icon wb-plus" aria-hidden="true"></i> Add Media Source
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="panel">
        <div class="panel-body" id="add-form" {!! count($errors) == 0 ? "style='display: none;'" : '' !!}>
            ...
            <form class="form-horizontal" id="form" action="{{ route('client.master.media-source.store') }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class='row'>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#datatable').dataTable({
                ...
                ajax: {
                    method: 'POST',
                    url : '{{ route('client.master.media-source.data') }}',
                    headers: {
