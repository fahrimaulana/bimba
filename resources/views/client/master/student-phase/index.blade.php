...
@section('head')
    <title>Student Phase List | {{ env('APP_NAME') }}</title>
...
@push('breadcrumb')
    <li class="breadcrumb-item active">Student Phase</li>
@endpush
...
@section('content')
    <div class="panel">
        <div class="panel-body">
            ...
            @can('create-student-phase')
            <div class="row">
                <div class="col-xs-12">
                    <div class="m-b-15">
                        <a id="add-btn" class="btn btn-primary white">
                            <i class="icon wb-plus" aria-hidden="true"></i> Add Student Phase
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="panel">
        <div class="panel-body" id="add-form" {!! count($errors) == 0 ? "style='display: none;'" : '' !!}>
            <h3>Add New Student Phase</h3>
            @include('inc.error-list')
            <form class="form-horizontal" id="form" action="{{ route('client.master.student-phase.store') }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class='row'>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#datatable').dataTable({
                ...
                ajax: {
                    method: 'POST',
                    url : '{{ route('client.master.student-phase.data') }}',
                    headers: {
