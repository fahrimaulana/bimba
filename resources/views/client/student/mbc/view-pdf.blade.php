		...
		<div id="header">
         ...
         <div class="content-header">
		   ...
		   <table class="content-table" style="float: left; width: 100%">
				<tr>
				 <th style="text-align: left;"><u>1. BILL PAYMENT <font color="#10f70c">(VIA BANK MANDIRI)</font></u></th>
				</tr>
				 <tr>
			 ...
			 <table class="content-table" id="table" style="float: left; width: 50%">
				 <tr>
					...
					<th width="25%" style="background-color: #77d1dc">No Cabang</th>
					<th width="25%" style="background-color: #77d1dc">NIM</th>
				 </tr>
				 <tr align="center">
					 <td id="table" height="40">Jumlah</td>
					 <td id="table">2 Digit</td>
					 <td id="table">5 Digit</td>
					 <td id="table">4 Digit</td>
				 </tr>
				 <tr align="center">
					 <td id="table" rowspan="2">Bill Payment</td>
					 <td id="table">&nbsp;</td>
					 <td id="table" height="40">- 00246 -</td>
					 <td id="table">&nbsp;</td>
				 </tr>
				 <tr align="center">
					 <td id="table" colspan="3" height="40"><font color="#0B02D9" size=5px>- 00246 -</font></td>
				 </tr>
			 </table>
			 <table class="content-table" style="float: left; width: 100%">
				 <tr>
			 ...
			 <table class="content-table" style="float: left; width: 100%">
				<tr>
				 <th style="text-align: left;"><u>2. VIRTUAL ACCOUNT <font color="#10f70c">(VIA BANK LAIN)</font></u></th>
				</tr>
				 <tr>
					<th width="100%" style="text-align: left;">&nbsp; &nbsp; a) Format Kode Nomor Pembayaran</th>
				 </tr>
			 ...
			 <table id="table" class="content-table" style="float: left; width: 55%">
				 <tr>
					...
					<th width="20%" style="background-color: #77d1dc">No Cabang</th>
					<th width="20%" style="background-color: #77d1dc">NIM</th>
				 </tr>
				 <tr align="center">
					 <td id="table" height="40">Jumlah</td>
					 <td id="table">5 Digit</td>
				 ...
				 <tr align="center">
					 <td id="table" rowspan="2">Bill Payment</td>
					 <td id="table">88912</td>
					 <td id="table" height="40">&nbsp;</td>
					 <td id="table">00246</td>
					 <td id="table" height="40">&nbsp;</td>
				 </tr>
				 <tr align="center">
					 <td id="table" colspan="4" height="40"><font color="#0B02D9" size=5px>88912 - - 00246 -</font></td>
				 </tr>
			 </table>
			 <table class="content-table" style="float: left; width: 50%">
				 ...
				 <tr>
					 <td>&emsp; &emsp; &#8594; Masukkan kode <b>Kode Perusahaan 88912 (jika diminta)</b></td>
				 </tr>
				 <tr>
