           ...
           <table class="content-table" style="float: left; width: 100%">
             ...
             <table class="content-table" id="table" style="float: left; width: 50%">
                 ...
                 <tr align="center">
                     ...
                     <td id="table">{{ $student->nim }}</td>
                 </tr>
                 <tr align="center">
                     <td id="table" colspan="3" height="40"><font color="#0B02D9" size=5px>{{ optional($student->department)->code }} - 00246 - {{ $student->nim }}</font></td>
                 </tr>
             </table>
             <table class="content-table" style="float: left; width: 100%">
                 <tr>
             ...
             <table id="table" class="content-table" style="float: left; width: 55%">
                 ...
                 <tr align="center">
                     ...
                     <td id="table" height="40">{{ $student->nim }}</td>
                 </tr>
                 <tr align="center">
                     <td id="table" colspan="4" height="40"><font color="#0B02D9" size=5px>88912 - {{ optional($student->department)->code }} - 00246 - {{ $student->nim }}</font></td>
                 </tr>
             </table>
