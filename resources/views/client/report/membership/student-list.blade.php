...
@section('head')
    <title>Report Murid | {{ env('APP_NAME') }}</title>
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item active">Repor Murid</li>
@endpush
...
@section('content')
    <div class="panel">
        <div class="panel-body">
            ...
            <form class="form-horizontal" action="{{ route('client.report.membership.student.display-pdf') }}" method="POST">
                {!! csrf_field() !!}
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="sort_by" class="form-control select2" data-placeholder="Choose One">
                            ...
                            <option value="name" {{ (old('sort_by') == 'name') ? 'selected' : '' }}>Nama</option>
                            <option value="tempat_lahir" {{ (old('sort_by') == 'tempat_lahir') ? 'selected' : '' }}>Tempat Lahir</option>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <button type="submit" formaction="{{ route('client.report.membership.student.download-pdf') }}" class="btn btn-danger w100"><i class="fa fa-file-pdf-o"></i> Download Di  PDF</button>
                            </div>
                            <div class="form-group col-sm-6">
                                <button type="submit" formaction="{{ route('client.report.membership.student.download-excel') }}" class="btn btn-success w100"><i class="fa fa-file-excel-o"></i> Download Di Excel</button>
                            </div>
                            <div class="form-group col-sm-6">
                                <button type="submit" formaction="{{ route('client.report.membership.student.download-csv') }}" class="btn btn-info w100"><i class="fa fa-file-excel-o"></i> Download Di CSV</button>
                            </div>
                        </div>
                    </div>
                </div>
