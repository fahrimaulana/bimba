                ...
                <ul class="blocks blocks-100 blocks-xxl-4 blocks-lg-3 blocks-sm-2" data-plugin="matchHeight" id="reportList">
                    <li>
                        <div class="category">
                            ...
                            <h4>Murid Trial</h4>
                            <p>ini mengetahui jumlah murid trial</p>
                            <a href="{{ route('client.report.membership.trial-student.show-filter') }}">Lihat Daftar</a>
                        </div>
                    </li>
                    <li>
                        <div class="category">
                            ...
                            <h4>Buku Induk</h4>
                            <p>ini mengetahui jumlah buku induk</p>
                            <a href="{{ route('client.report.membership.student.show-filter') }}">Lihat Daftar</a>
                        </div>
                    </li>
                    <li>
                        <div class="category">
                            ...
                            <h4>Pindah Golongan</h4>
                            <p>ini mengetahu Murid Pindah Golongan</p>
                            <a href="{{ route('client.report.membership.move-grades.show-filter') }}">Lihat Daftar</a>
                        </div>
                    </li>
                </ul>
            </div>
