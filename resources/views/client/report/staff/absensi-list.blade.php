...
@section('head')
    <title>Report Staff Absensi | {{ env('APP_NAME') }}</title>
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item active">Report Staff Absensi</li>
@endpush
...
@section('content')
    <div class="panel">
        <div class="panel-body">
            ...
            <form class="form-horizontal" action="{{ route('client.report.staff.absensi.display-pdf') }}" method="POST">
                {!! csrf_field() !!}
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <button type="submit" formaction="{{ route('client.report.staff.absensi.download-pdf') }}" class="btn btn-danger w100"><i class="fa fa-file-pdf-o"></i> Download Di  PDF</button>
                            </div>
                            <div class="form-group col-sm-6">
                                <button type="submit" formaction="{{ route('client.report.staff.absensi.download-excel') }}" class="btn btn-success w100"><i class="fa fa-file-excel-o"></i> Download Di Excel</button>
                            </div>
                            <div class="form-group col-sm-6">
                                <button type="submit" formaction="{{ route('client.report.staff.absensi.download-csv') }}" class="btn btn-info w100"><i class="fa fa-file-excel-o"></i> Download Di CSV</button>
                            </div>
                        </div>
                    </div>
                </div>
