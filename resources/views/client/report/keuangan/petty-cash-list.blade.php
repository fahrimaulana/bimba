...
@section('head')
    <title>Report Petty Cash List | {{ env('APP_NAME') }}</title>
...
@push('breadcrumb')
    ...
    <li class="breadcrumb-item active">Report Petty Cash List</li>
@endpush
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="sort_by" class="form-control select2" data-placeholder="Choose One">
                            <option></option>
                            <option value="no_bukti" {{ (old('sort_by') == 'no_bukti') ? 'selected' : '' }}>NO Bukti</option>
                        </select>
                    </div>
                </div>
