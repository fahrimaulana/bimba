...
@section('head')
    <title>Ubah Order ATK | {{ env('APP_NAME') }}</title>
...
@push('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('client.order.atk.index') }}">Order ATK</a></li>
    <li class="breadcrumb-item active">Ubah Order ATK</li>
@endpush

@section('content')
    <div class="panel">
        <div class="panel-body">
            <h3>Ubah Order ATK</h3>
            @include('inc.error-list')
            <form class="form-horizontal" id="form" action="{{ route('client.order.atk.update', $transaction->id) }}" method="POST">
                {!! method_field('PUT') !!}
                {!! csrf_field() !!}
                <div class='row'>
                    ...
                    <div class='form-group col-md-4'>
                        ...
                        <input type='text' name='note' class='form-control' value='{{ old('note', $transaction->note) }}' />
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group">
                    <a href="{{ route('client.order.atk.index') }}" class="btn btn-danger">Kembali</a>
